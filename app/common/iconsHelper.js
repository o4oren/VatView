export const mapIcons = {
    ...
    tower: require('../../assets/atc/tower-64.png'),
    antenna: require('../../assets/atc/radio-antenna-64.png'),
    radar: require('../../assets/atc/radar-64.png'),
    towerRadar: require('../../assets/atc/tower-radar-64.png'),
    antennaRadar: require('../../assets/atc/antenna-radar-64.png'),
    mapTower: require('../../assets/atc/tower-32.png'),
    mapAntenna: require('../../assets/atc/radio-antenna-32.png'),
    mapRadar: require('../../assets/atc/radar-32.png'),
    mapTowerRadar: require('../../assets/atc/tower-radar-32.png'),
    mapAntennaRadar: require('../../assets/atc/antenna-radar-32.png'),
};
